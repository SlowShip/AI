...
{
    public class DepthFirstSearchFringeTestFixture
    {
        ...
        [Fact]
        public void GetNext_WhenTheFringeIsNotEmpty_ShouldReturnItemsInALastInFirstOutOrder()
        {
            // Arrange
            ...
            // Assert
            Assert.Equal(out_1, in_3);
            Assert.Equal(out_2, in_2);
            Assert.Equal(out_3, in_1);
        }
